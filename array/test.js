...
const taskPromise = async (i) => {
  await sleep(1000)
  console.log(`tast ${i} done`)
  return ++i
}

const taskArr = [taskPromise, taskPromise, taskPromise, taskPromise]
taskArr.reduce(async (accumulator, currentval) => {
